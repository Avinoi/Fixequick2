  ...
  const chats = [
    {
      ...
      lastMessage: 'I will be there by 2 PM',
    ...
    },
    {
      ...
      lastMessage: 'Can you bring the tools needed?',
              ...
              <>
                ...
                <div className="p-4 border-b border-gray-200">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full overflow-hidden bg-gray-200">
                      {chats.find(c => c.id === selectedChat)?.avatar ? (
                        <img 
                          ...
                          alt={chats.find(c => c.id === selectedChat)?.customerName} 
                          className="w-full h-full object-cover" 
                        />
                      ) : (
                        <div className="w-full h-full flex items-center justify-center bg-blue-100 text-blue-500 text-xl font-bold">
                    ...
                    <div>
                      <h3 className="font-medium">{chats.find(c => c.id === selectedChat)?.customerName}</h3>
                    ...
                    {getChatMessages(selectedChat).map(message => (
                      ...
                      >
                        ...
                        <span className={`text-xs absolute bottom-1 right-2 ${
                          message.senderId === 'worker1' ? 'text-blue-100' : 'text-gray-500'
                        }`}>
